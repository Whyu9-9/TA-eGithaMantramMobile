...
class AllGamelanNotOnProsesiAdminAdapter(private var results: ArrayList<AllGamelanAdminModel>)
    : RecyclerView.Adapter<AllGamelanNotOnProsesiAdminAdapter.ViewHolder>() {
    private var onclickAdd: ((AllGamelanAdminModel)->Unit)? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val inflatedView = layoutInflater.inflate(R.layout.layout_all_gamelan_not_on_prosesi_admin, parent, false)
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view) {
        var add : ImageView = view.findViewById(R.id.addGamelanToProsesi)
        private var title : TextView = view.findViewById(R.id.titleNP_gamelan_admin)
        private var jenis : TextView = view.findViewById(R.id.jenisNP_gamelan_admin)
        private var gambar : ImageView = view.findViewById(R.id.gamelanNP_imgs_admin)
