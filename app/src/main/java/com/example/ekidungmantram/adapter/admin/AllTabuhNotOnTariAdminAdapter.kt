...
class AllTabuhNotOnTariAdminAdapter(private var results: ArrayList<AllTabuhAdminModel>)
    : RecyclerView.Adapter<AllTabuhNotOnTariAdminAdapter.ViewHolder>() {
    private var onclickAdd: ((AllTabuhAdminModel)->Unit)? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val inflatedView = layoutInflater.inflate(R.layout.layout_all_tabuh_not_on_tari_admin, parent, false)
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view) {
        var add : ImageView = view.findViewById(R.id.addTabuhToTari)
        private var title : TextView = view.findViewById(R.id.titleNTr_tabuh_admin)
        private var jenis : TextView = view.findViewById(R.id.jenisNTr_tabuh_admin)
        private var gambar : ImageView = view.findViewById(R.id.tabuhNTr_imgs_admin)
